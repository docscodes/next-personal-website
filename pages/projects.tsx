...
function ProjectItem(props: ProjectItemProps) {
  const { name, url, urlDisplay, imageSrc: image } = props
    ...
    <a href={url}>
      <div className="max-w-sm rounded overflow-hidden shadow-lg">
        ...
        <div className="px-6 pb-4">
          <span className="inline-block bg-gray-200 rounded-full px-3 py-1 ext-sm font-semibold text-gray-700 mr-2 mb-2">🔗 {urlDisplay}</span>
        </div>
      </div>
    </a>
  </li>
  ...
  return <div className="mt-16 px-8">
    ...
    <div className="mt-16">
      ...
      <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-16 mt-8">
        ...
        < ProjectItem name={"RedacApp: Redact Text In Images"}
      ...
      <div className="mt-16">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-16 mt-8">
          ...
          <ProjectItem name={"Nail A Coding Interview: Six-Step Mental Framework"}
            url={"https://gracehuang.gumroad.com/l/coding-interview"}
            urlDisplay={"gracehuang.gumroad.com"}
            imageSrc={imageBookCodingInterview} />
          <ProjectItem name={"A Practical Guide to Writing a Software Tech Design Doc"}
